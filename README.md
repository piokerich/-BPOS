...
- **Premium UI**: Glassmorphism aesthetic with smooth transitions and responsive layouts.
- **Order Modes**: Support for Dine In, Take Away, and Delivery.
- **Receipt System**: Optimized for A5 paper and 80mm thermal printers.
- **Security**: Professional login portal with session management.
...
---
*Developed for the Berkley Hotel Standards.*
